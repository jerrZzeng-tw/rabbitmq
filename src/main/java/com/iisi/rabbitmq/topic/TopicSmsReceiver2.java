...
public class TopicSmsReceiver2 {

    @RabbitHandler
    public void smsMessage(CustomMessage msg, Channel channel, Message message) throws IOException {
        try {
            log.info("sms2 topic --接收到消息：{}", msg);
